...
import com.app.sample.GoFleetNavigation.adapter.PageFragmentAdapter;

import com.app.sample.GoFleetNavigation.data.GlobalVariable;
import com.app.sample.GoFleetNavigation.data.Tools;
import com.app.sample.GoFleetNavigation.fragment.PageClientFragment;
import com.app.sample.GoFleetNavigation.fragment.PageHomeFragment;
...
public class ActivityMain extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
  ...
  //  private FirebaseAuth firebaseAuth;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String temp = (String) getIntent().getSerializableExtra("User");
        ...
        if(modelApi.getUser() != null)
        {
            navUsername.setText(modelApi.getUser().getName() + " " + modelApi.getUser().getSurname());
        }
