...
public class ActivityRouteFinished extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Scan Client Invoice");

        orderOBJ = (Order) getIntent().getSerializableExtra("orderObj");
        camScan = (Boolean) getIntent().getSerializableExtra("camScan");


        fab = findViewById(R.id.fabb);
        fabScan = findViewById(R.id.fabScann);
        ...
        clientBricks.setText("Bricks: " + orderOBJ.getBrickQ());
        ...
        clientSand.setText("Sand Bags: " + orderOBJ.getSandQ());
        ...
        if(camScan == true && orderOBJ.isDelivered() == false)
        {
            ...
            fabScan.setOnClickListener(new View.OnClickListener() {
                ...
                {
                    Intent intent = new Intent(ActivityRouteFinished.this, LiveBarcodeScanningActivity.class);
                    intent.putExtra("orderObj",orderOBJ); //passes objects
    ...
    {
        Intent intent = new Intent(ActivityRouteFinished.this, ActivityDelayedOrders.class);
    ...
    private void fabToggle()
    {
        ...
        //start Map
        Intent intent = new Intent(ActivityRouteFinished.this, MapActivity.class);
        intent.putExtra("orderObj",orderInfo); //passes objects
        startActivity(intent);
    }
