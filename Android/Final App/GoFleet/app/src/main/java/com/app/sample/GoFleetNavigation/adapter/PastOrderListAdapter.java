...
public class PastOrderListAdapter extends RecyclerView.Adapter<PastOrderListAdapter.ViewHolder> implements Filterable
{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder  //items
    {
        ...
        public ViewHolder(View v) {
            super(v);
            RouteID = (TextView) v.findViewById(R.id.route);

            DeliverByDate = (TextView) v.findViewById(R.id.DeliverByDatePast);
    ...
    public PastOrderListAdapter(OnItemClickListener ctx, List<Order> items)
    {
        mOnItemClickListener = ctx;
        original_items = items;
        filtered_items = items;
    }

    public PastOrderListAdapter(Context ctx, List<Order> items) {
        this.ctx = ctx;
        original_items = items;
        filtered_items = items;
    }
    ...
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)  //item order
    {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position)
    {
        ...
        holder.RouteID.setText("Route: " + p.getRoute_ID());
