...
public class Order implements Serializable
{
    ...
    public Order(String ID, String street, String subrub, String sequenceNumber, String placeID, double longitude, double latitude, boolean delivered)
    {
        this.ID = ID;
        this.street = street;
        this.suburb = subrub;
    ...
    public static Order getOrder(JSONObject jsonObject, JSONObject jsonObject2) throws JSONException //takes json object and given back user object
    {
        ...
        boolean order_delivered = Boolean.parseBoolean(jsonObject.getString("order_Delivered"));

        Order order = new Order(id,street,subrub,sequence_number,place_id,location_longtitude,location_latitude,order_delivered);
