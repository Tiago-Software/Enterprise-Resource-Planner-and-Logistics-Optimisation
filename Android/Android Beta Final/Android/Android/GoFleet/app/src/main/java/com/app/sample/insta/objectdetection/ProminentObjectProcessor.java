...
//import com.app.sample.insta.camera.FrameProcessorBase;
...
//        graphicOverlay.add(
//            new ObjectGraphicInProminentMode(graphicOverlay, objects.get(0), confirmationController));
...
//        graphicOverlay.add(new ObjectGraphicInProminentMode(graphicOverlay, objects.get(0), confirmationController));
//        graphicOverlay.add(new ObjectReticleGraphic(graphicOverlay, cameraReticleAnimator));
//        cameraReticleAnimator.start();
//      }
//    }
